...
- (void)add:(nonnull NSArray *)tracks insertBeforeIndex:(nonnull NSNumber *)insertBeforeIndex resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer addWithTrackDicts:tracks before:insertBeforeIndex resolve:resolve reject:reject]);
}
...
- (void)getActiveTrack:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer getActiveTrackWithResolve:resolve reject:reject]);
}

- (void)getActiveTrackIndex:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer getActiveTrackIndexWithResolve:resolve reject:reject]);
}
...
- (void)load:(nonnull NSDictionary *)track resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer loadWithTrackDict:track resolve:resolve reject:reject]);
}
...
- (void)move:(double)fromIndex toIndex:(double)toIndex resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer moveFromIndex:fromIndex toIndex:toIndex resolve:resolve reject:reject]);
}

- (void)pause:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer pauseWithResolve:resolve reject:reject]);
}

- (void)play:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer playWithResolve:resolve reject:reject]);
}
...
- (void)setPlayWhenReady:(BOOL)playWhenReady resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setPlayWhenReadyWithPlayWhenReady:playWhenReady resolve:resolve reject:reject]);
}
...
- (void)setQueue:(nonnull NSArray *)tracks resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setQueueWithTrackDicts:tracks resolve:resolve reject:reject]);
}

- (void)setRate:(double)rate resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setRateWithRate:rate resolve:resolve reject:reject]);
}
...
- (void)setRepeatMode:(double)mode resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setRepeatModeWithRepeatMode:@(mode) resolve:resolve reject:reject]);
}

- (void)setVolume:(double)level resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setVolumeWithLevel:level resolve:resolve reject:reject]);
}
...
- (void)setupPlayer:(nonnull NSDictionary *)options resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setupPlayer:options resolver:resolve rejecter:reject]);
}
...
- (void)skip:(double)index initialPosition:(nonnull NSNumber *)initialPosition resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer skipTo:index initialTime:initialPosition.doubleValue resolve:resolve reject:reject]);
}
...
- (void)skipToNext:(nonnull NSNumber *)initialPosition resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer skipToNextWithInitialTime:initialPosition.doubleValue resolve:resolve reject:reject]);
}
...
- (void)skipToPrevious:(nonnull NSNumber *)initialPosition resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer skipToPreviousWithInitialTime:initialPosition.doubleValue resolve:resolve reject:reject]);
}

- (void)stop:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer stopWithResolve:resolve reject:reject]);
}
...
- (void)updateMetadataForTrack:(double)trackIndex metadata:(nonnull NSDictionary *)metadata resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer updateMetadataFor:trackIndex metadata:metadata resolve:resolve reject:reject]);
}
...
- (void)updateNowPlayingMetadata:(nonnull NSDictionary *)metadata resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer updateNowPlayingMetadataWithMetadata:metadata resolve:resolve reject:reject]);
}
...
- (void)updateOptions:(nonnull NSDictionary *)options resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer updateOptions:options resolver:resolve rejecter:reject]);
}
...
- (void)setSleepTimer:(double)seconds resolve:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer setSleepTimerWithSeconds:seconds resolve:resolve reject:reject]);
}

- (void)getSleepTimer:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer getSleepTimerWithResolve:resolve reject:reject]);
}

- (void)clearSleepTimer:(nonnull RCTPromiseResolveBlock)resolve reject:(nonnull RCTPromiseRejectBlock)reject {
  RNTP_SAFE_CALL(reject, [nativeTrackPlayer clearSleepTimerWithResolve:resolve reject:reject]);
}
